...
namespace GosuMechanics_Vayne.Common
{
    ...
    public static class Damage
    {
        ...
        public static double GetAutoAttackDamage2(
            ...
            bool includePassive = false)
        {
            ...
            if (hero != null)
            {
                ...
                {
                    if (
                        EntityManager.Heroes.AllHeroes.Any(
                            h =>
                            ...
                            && h.Distance(minionTarget.Position) < 1100))
                    {
                        ...
                        if (Item.HasItem(3302, hero))
                        {
                            value = 200; // Relic Shield
                        }
                        else if (Item.HasItem(3097, hero))
                        {
                            value = 240; // Targon's Brace
                        }
                        else if (Item.HasItem(3401, hero))
                        {
        ...
        {
            return spellCombo.Sum(spell => source.GetSpellDamage2(target, spell.Item1, spell.Item2));
        }
        ...
        public static double GetSpellDamage2(this AIHeroClient source, Obj_AI_Base target, SpellSlot slot, int stage = 0)
        {
            ...
            DamageType damageType)
        {
            ...
            if (targetHero != null)
            {
                ...
                if (Item.HasItem(1054, targetHero))
                {
                    amount -= 8;
                }
        ...
        {
            public delegate float GetDamageD(AIHeroClient source, Obj_AI_Base target);
